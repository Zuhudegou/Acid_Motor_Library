...
#include "FOC.h"
/* 电机控制User用户设置·电机参数(FOC) */

/**
 * @description: 实体参数填写函数的初始化代码
 * @reminder: (此方函数->填写电机实际物理参数)
 * @param {FOC_System_STRUCT} *user
 * @return {*}
 */
static inline void User_Motor_Init(FOC_System_STRUCT *user){
    // +---------------------------------------------------------+
    // |                  电机实体参数Motor填写                   |
    // +---------------------------------------------------------+
    // 1.FOC.foc参数设计(最初始的Target数值)
